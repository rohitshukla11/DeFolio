/**
 * Footer Component
 * Displays sponsor attribution and project info
 */
...
export default function Footer() {
  return (
    <footer className="mt-12 border-t border-gray-200 dark:border-gray-800">
      {/* Powered by Envio Banner */}
      <div className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 text-white">
      ...
      <div className="bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 py-6">
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            <div className="mb-2">
              Built for <span className="font-semibold">ETHOnline 2025</span> - Best Live Web3 Dashboard
            </div>
            <div className="flex items-center justify-center gap-2 flex-wrap">
              <span>Powered by</span>
              <span className="font-semibold text-blue-600 dark:text-blue-400">Envio HyperSync</span>
              <span>•</span>
              <span className="font-semibold text-purple-600 dark:text-purple-400">Pyth Network</span>
              <span>•</span>
              <span className="font-semibold text-pink-600 dark:text-pink-400">Avail Nexus</span>
            </div>
            <div className="mt-3 text-xs text-gray-500 dark:text-gray-500">
              © 2025 DeFolio. Built with ❤️ for the Web3 community.
            </div>
          </div>
        </div>
      </div>
